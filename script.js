...
document.getElementById("signupForm")?.addEventListener("submit", function (e) {
    ...
    fetch('http://13.208.252.108/api/signup', {
        method: 'POST',
...
document.getElementById("loginForm")?.addEventListener("submit", function (e) {
    ...
    fetch('http://13.208.252.108/api/login', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
document.getElementById("sendOtp")?.addEventListener("click", function () {
    ...
    fetch('http://13.208.252.108/api/send-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
document.getElementById("resetForm")?.addEventListener("submit", function (e) {
    ...
    fetch('http://13.208.252.108/api/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
document.addEventListener('DOMContentLoaded', () => {
   ...
   document.getElementById('show-profile-btn').addEventListener('click', () => {
    ...
    fetch(`http://13.208.252.108/api/get-profile/${userId}`, { // Use userId in the URL
        method: 'GET',
    ...
    fetch('http://13.208.252.108/api/submit-feedback', {
        method: 'POST',
        headers: {
